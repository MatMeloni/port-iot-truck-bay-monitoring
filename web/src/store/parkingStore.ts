...
// Lê a lista de vagas do .env (ex.: "A1,A2,A3,B1,B2,B3")
const targetIds =
...
export const useParkingStore = create<ParkingStore>((set, get) => ({
  ...
  targetIds,
  replicateFrom: "A1", // por padrão replica A1
